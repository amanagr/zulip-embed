...
[`ARCHITECTURE.md`](./ARCHITECTURE.md) for the bundle / registration
model, [`events.md`](./events.md) for the element surface, and the
live [playground at `demo/index.html`](https://amanagr.github.io/zulip-embed/#playground)
...
- [`docs/ARCHITECTURE.md`](./ARCHITECTURE.md) — shadow-DOM isolation
  model, why `--zc-*` is the only hook.
- [`docs/events.md`](./events.md) — widget events fired from inside
